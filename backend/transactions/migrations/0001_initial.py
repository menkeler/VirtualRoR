    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(blank=True, choices=[('Good', 'Good'), ('Slightly Damaged', 'Slightly Damaged'), ('Damaged', 'Damaged'), ('Broken', 'Broken'), ('Lost', 'Lost')], max_length=50, null=True)),
