# Generated by Django 4.2.7 on 2024-05-08 21:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('condition', models.CharField(choices=[('Good', 'Good'), ('Slightly Damaged', 'Slightly Damaged'), ('Damaged', 'Damaged'), ('Broken', 'Broken'), ('Lost', 'Lost')], default='Good', max_length=50)),
