      ...
      <div className='shadow-lg bg-neutral-100 p-4 w-full'>
        ...
        <Link to="/Home" className="justify-between">
          <img
            ...
            src="/public/Logo.png"
            className="w-100 h-16 lg:w-100 lg:h-16"  // Adjust the width and height based on your preference
          />
        </Link>
      </div>
         ...
         {isLoggedIn && (
        <div className={`lg:px-64 lg:grid lg:grid-cols-${userData?.user?.staff ? 4 : 3} lg:gap-4 lg:justify-center hidden lg:flex`}>
