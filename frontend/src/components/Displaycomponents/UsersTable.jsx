    ...
    if (type === 1) {
      ...
      <div className="mt-4 grid gap-4 grid-cols-6">
        {users.map((user) => (
            ...
            <h2 className="text-base font-semibold overflow-hidden overflow-ellipsis whitespace-nowrap mb-2">
                {user.first_name} {user.last_name}
            </h2>
            <p className="text-sm text-gray-600 overflow-hidden overflow-ellipsis whitespace-nowrap mb-2">
                {user.email}
            </p>
            <button
