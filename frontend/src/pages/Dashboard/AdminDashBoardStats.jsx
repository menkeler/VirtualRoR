...
const AdminDashBoardStats = () => {
  ...
  const endpoints = {
    ...
    lostAndBorrwedItems:
      "/inventory/item-copies/get_borrowed_and_lost_items_count/",
  };
  ...
  const fetchData = async () => {
    ...
    try {
      if (authToken) {
        const dataPromises = Object.entries(endpoints).map(
          async ([key, endpoint]) => {
        ...
        <div className="grid grid-cols-6 gap-4">
          ...
          <div className="col-span-1 stats shadow">
            <div className="stat">
              ...
              <div className="stat-value">
                {alldata.totalUsers.total_users_count}
              </div>
          ...
          <div className="col-span-1 stats shadow">
            <div className="stat">
              ...
              <div className="stat-value">
                {alldata.totalTransaction.total_transactions}
              </div>
          ...
          <div className="col-span-1 stats shadow">
            <div className="stat">
              ...
              <div className="stat-value">
                {alldata.lostAndBorrwedItems.borrowed_items_count}
              </div>
          ...
          <div className="col-span-1 stats shadow">
            <div className="stat">
              ...
              <div className="stat-value">
                {alldata.lostAndBorrwedItems.lost_items_count}
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm mb-2">
                      Name: {alldata.newestUsers.first_name}{" "}
                      {alldata.newestUsers.last_name}
                    </p>
                    <p className="text-sm mb-2">
                      Email: {alldata.newestUsers.email}
                    </p>
                    <p className="text-sm mb-2">
                      Contact: {alldata.newestUsers.contact}
                    </p>
                    <p className="text-sm mb-2">
                      Department: {alldata.newestUsers.department}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-body bg-base-100">
                <div className="grid grid-cols-2 items-center">
                  <div className="text-left">
                    <p className="text-sm mb-2">
                      User: {alldata.latestTransactions.participant.first_name}{" "}
                      {alldata.latestTransactions.participant.last_name}
                    </p>
                    <p className="text-sm mb-2">
                      Email: {alldata.latestTransactions.participant.email}
                    </p>
                    <p className="text-sm mb-2">
                      Contact: {alldata.latestTransactions.participant.contact}
                    </p>
                    <p className="text-sm mb-2">
                      Department:{" "}
                      {alldata.latestTransactions.participant.department}
                    </p>
                  </div>

                  <div className="text-right">
                    <p className="text-sm mb-2">
                      ID: {alldata.latestTransactions.id}{" "}
                    </p>
                    <p className="text-sm mb-2">
                      Status:{" "}
                      {alldata.latestTransactions.is_active
                        ? "Active"
                        : "Completed"}
                    </p>
                    <p className="text-sm mb-2">
                      Type: {alldata.latestTransactions.transaction_type}{" "}
                    </p>
                  </div>
                </div>
                ...
                <button
                  ...
                  onClick={() =>
                    document
                      .getElementById(`Detail${alldata.latestTransactions.id}`)
                      .showModal()
                  }
                >
                  View more
                ...
                <TransactionDetails
                  ...
                  transaction={alldata.latestTransactions}
                />
              </div>
            </div>
          )}
            ...
            <div className="col-span-2 card shadow bg-base-100">
              ...
              <div className="card-body bg-base-100">
                <div className="grid grid-cols-2 items-center">
                  <div className="text-left">
                    <p className="text-sm mb-2">
                      User: {alldata.latestInquiry.inquirer.first_name}{" "}
                      {alldata.latestInquiry.inquirer.last_name}
                    </p>
                    <p className="text-sm mb-2">
                      Email: {alldata.latestInquiry.inquirer.email}
                    </p>
                    <p className="text-sm mb-2">
                      Contact: {alldata.latestInquiry.inquirer.contact}
                    </p>
                    <p className="text-sm mb-2">
                      Department: {alldata.latestInquiry.inquirer.department}
                    </p>
                  </div>

                  <div className="text-right">
                    <p className="text-sm mb-2">
                      ID: {alldata.latestInquiry.id}{" "}
                    </p>
                    <p className="text-sm mb-2">
                      Status: {alldata.latestInquiry.status}{" "}
                    </p>
                    <p className="text-sm mb-2">
                      Type: {alldata.latestInquiry.inquiry_type}{" "}
                    </p>
                  </div>
                </div>
                <button
                  ...
                  onClick={() =>
                    document
                      .getElementById(
                        `DetailInquiry${alldata.latestInquiry.id}`
                      )
                      .showModal()
                  }
                >
